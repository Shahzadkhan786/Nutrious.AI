...
export async function POST(request: Request) {
  try {
    ...
    console.error("Error:", error); // Log specific errors for debugging
    return NextResponse.json({ status: "failure", error: "Internal Server Error" }); // Generic error message for user
  }
}